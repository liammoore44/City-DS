...
def plot_pitch_control_for_frame(frame, tracking_home, tracking_away, attacking_team, params, alpha = 0.7, include_player_velocities=True, annotate=True, field_dimen = (106.,68.,), n_grid_cells_x = 50):
...
def plot_pitch_control_for_event(event_id, events, tracking_home, tracking_away, params, alpha = 0.7, include_player_velocities=True, annotate=True, field_dimen = (106.,68.,), n_grid_cells_x = 50):
    ...
    # generate pitch control
    PPCF, xgrid, ygrid=pc.generate_pitch_control_for_frame(pass_frame, tracking_home, tracking_away, events, params, field_dimen = field_dimen, n_grid_cells_x = n_grid_cells_x)
...
def generate_relevant_pitch_for_frame(frame, tracking_home, tracking_away, attacking_team, params, field_dimen = (106.,68.,), n_grid_cells_x = 50):
    ...
    PPCFa,xgrid,ygrid,T = pc.generate_transition_probability_for_frame(frame, tracking_home, tracking_away, attacking_team, params, field_dimen = field_dimen, n_grid_cells_x = n_grid_cells_x)
    rel_PPCF = PPCFa*T
